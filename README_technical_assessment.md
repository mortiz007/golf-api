# README_technical_assessment — LLM Choice, Failure Handling & AI Assistance

Short companion notes for the Golf Listing API. For full setup/run/test details see [AGENTS_technical_assessment.md](AGENTS_technical_assessment.md).
...
- Generating the Postman collection (`postman/golf-api.postman_collection.json`) with positive/negative cases and automated flows, derived from reading the controllers, FormRequests and seeders.
- Writing prompts and the JSON response mapping for the Ollama adapter.
- Documentation.

**Rejected:**
- To design the solution by its own.
